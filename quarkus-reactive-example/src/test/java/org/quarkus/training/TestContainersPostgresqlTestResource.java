...
public class TestContainersPostgresqlTestResource {
    public static class Initializer implements QuarkusTestResourceLifecycleManager {
        ...
        private Map<String, String> configurationParameters() {
            ...
            config.put("quarkus.datasource.reactive.url", postgreSQLContainer.getJdbcUrl().replaceAll("jdbc:", ""));
            System.out.println("***** INIT " + postgreSQLContainer.getJdbcUrl().replaceAll("jdbc:", ""));
